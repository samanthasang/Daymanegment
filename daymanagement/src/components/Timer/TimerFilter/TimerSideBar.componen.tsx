...
function TimerSideBar() {
  ...
  const onSubmit = () => {
    console.log(
      "onSubmit",
      dayjs(dayjs.unix(Number(currentUnixTimestamp))).format("YYYY-MM-DD HH:mm")
    );
          ...
          <div className={cn("flex flex-col justify-start gap-y-3 w-full")}>
            ...
            <div className="col-span-1 w-full">
              <Button
                onClick={() => onSubmit()}
                type="submit"
                className="rounded cursor-pointer w-64 mt-10 mx-auto text-white bg-background border border-white"
              >
                submit
              </Button>
            </div>
